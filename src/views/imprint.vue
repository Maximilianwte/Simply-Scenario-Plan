    ...
    <div id="message" class="flex-col">
      ...
      <div id="contact" class="text-center text-2xl mt-10">
        ...
        <div class="privacy text-sm mt-20 text-justify mb-12 px-24">
          ...
          <h2 class="text-lg mt-4 mb-4">Consent</h2>

          <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

          <h2 class="text-lg mt-4 mb-4">Information we collect</h2>
          ...
          <h2 class="text-lg mt-4 mb-4">How we use your information</h2>
          ...
          <h2 class="text-lg mt-4 mb-4">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
          ...
          <h2 class="text-lg mt-4 mb-4">GDPR Data Protection Rights</h2>
          ...
          <h2 class="text-lg mt-4 mb-4">Children's Information</h2>
