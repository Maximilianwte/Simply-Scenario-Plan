<template>
  <div id="outputs" class="lg:px-10 flex-col py-12 w-full">
    ...
    <div class="fixed left-0 top-0 h-screen">
      <button id="backUIStep" class="fixed hidden md:block left-0 centerY px-3 py-3 rounded-full text-2xl"
      ...
      <button id="nextUIStep2" class="absolute md:hidden text-xl bg-main hover:bg-focus text-white bottom-0 left-0 ml-3 rounded px-4 py-2" @click="moveUI('dec')">
      Back
    </button>
    </div>
  </div>
