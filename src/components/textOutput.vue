<template>
  <transition-group name="fade" tag="div">
    <div v-for="number in [index]" :key="number" class="textOutput flex-col md:flex-row text-xl md:w-128 py-12">
      <div class="left sm:hidden md:block md:w-2/3 mx-4">
        <p>{{ activeText }}</p>
      </div>
      <div class="right mt-6 md:mt-0 md:w-1/3 mx-4">
      ...
      <div class="left md:hidden mt-6 md:w-2/3 mx-4">
        <p>{{ activeText }}</p>
      </div>
    </div>
  </transition-group>
