      ...
      <div class="w-72 h-80" v-for="number in [index]" :key="number">
        <div class="svg flex-col">
          ...
          >
            <path
              stroke-width=".1"
              d="M61 61h2v2h-2zM1 61h2v2H1zM41.18 27H50v1c0 1.654 1.346 3 3 3s3-1.346 3-3v-1h2v-3.748l-17-5V16h9v1c0 1.654 1.346 3 3 3s3-1.346 3-3v-1h2v-3.748l-17-5V3h-2V1h-2v2H27V1h-2v2h-2v4.252l-17 5V16h2v1c0 1.654 1.346 3 3 3s3-1.346 3-3v-1h9v2.252l-17 5V27h2v1c0 1.654 1.346 3 3 3s3-1.346 3-3v-1h8.82l-5.667 34H5v2h54v-2H46.847zM39.1 41L32 46.557 24.9 41zm-14.186-2L32 33.489 39.086 39zm16.671 2.594l2.389 14.334-10.352-8.102zm-7.956-9.372l5.661-4.403 1.686 10.117zM37.086 27L32 30.955 26.914 27zm-9.866-2L32 21.714 36.78 25zM39 24.099L33.765 20.5 39 16.901zM36.78 16L32 19.286 27.22 16zm-8-2L32 12.591 35.22 14zm5.714-2.5L39 9.529v3.943zM32 10.409L28.78 9h6.44zM29.506 11.5L25 13.471V9.529zM25 16.901l5.235 3.599L25 24.099zm5.371 15.321l-7.347 5.714 1.686-10.117zm.007 15.604l-10.352 8.102 2.389-14.334zM32 49.095L42.1 57H21.9zM54 28a1 1 0 01-2 0v-1h2zm2-3.252V25H41v-4.664zM54 17a1 1 0 01-2 0v-1h2zm2-3.252V14H41V9.336zM39 5v2H25V5zM12 17a1 1 0 01-2 0v-1h2zm-4-3v-.252l15-4.412V14zm0 10.748l15-4.412V25H8zM12 28a1 1 0 01-2 0v-1h2zm7.514 31h24.973l.333 2H19.18z"
            />
          </svg>
        </div>
