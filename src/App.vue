<template>
  <div class="min-h-screen w-screen relative theme_light text-main_primary bg-bg_primary pb-8">
    <div class="flex pt-4 pl-4 items-center absolute text-bg_primary">
      <router-link class="mr-4 flex items-center" to="/"><svg class="svg-xl svg-light"
        ...
        <h1 class="px-4 text-2xl hover:text-main_secondary">The Cognitive Network.</h1>
      </router-link>
    </div>
    <div id="footer" class="absolute bottom-0 flex justify-between items-center text-md hover:text-main_secondary theme_dark h-8 w-screen bg-bg_primary text-main_primary">
    <router-link to="/imprint">
        <h5 class="px-4">Impressum</h5>
    </router-link>
