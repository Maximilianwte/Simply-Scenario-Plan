<template>
  <div class="min-h-screen w-screen theme_light text-main_primary bg-bg_primary">
    <div class="flex pt-4 pl-4 items-center absolute text-bg_primary">
      <router-link class="mr-4 flex items-center" to="/"><svg class="svg-xl svg-light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
